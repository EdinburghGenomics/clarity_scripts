...
class stepOutput:
    ...
    def setInputLUID(self, value):
        self.__inputLUID = value

    def getInputLUID(self):
        return self.__inputLUID

    def setOutputLUID(self, value):
        self.__LUID = value

    def getOutputLUID(self):
        return self.__LUID

    def setOutputType(self, value):
        self.__type = value

    def getOutputType(self):
        return self.__type

    def setIsShared(self, value):
        self.__isShared = value

    def getIsShared(self):
...
class IOMapper:
    ...
    def setStepURI(self, value):
        self.__stepURI = value

    def setAPIHandler(self, object):
        self.__APIHandler = object
