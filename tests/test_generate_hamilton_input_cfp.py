...
outputs1={
    ...
    'ai1': [Mock(id='ao1', container=NamedMock(real_name='OutputName1'), location=('ContainerVariable1', 'A:1'), udf={'CFP_DNA_Volume (uL)':'50', 'CFP_RSB_Volume (uL)':'10'})],
    'ai2': [Mock(id='ao1', container=NamedMock(real_name='OutputName1'), location=('ContainerVariable1', 'B:1'), udf={'CFP_DNA_Volume (uL)':'50', 'CFP_RSB_Volume (uL)':'10'})],
    'ai3': [Mock(id='bo1', container=NamedMock(real_name='OutputName1'), location=('ContainerVariable1', 'C:1'), udf={'CFP_DNA_Volume (uL)':'50', 'CFP_RSB_Volume (uL)':'10'})],
    'ai4': [Mock(id='bo1', container=NamedMock(real_name='OutputName1'), location=('ContainerVariable1', 'D:1'), udf={'CFP_DNA_Volume (uL)':'50', 'CFP_RSB_Volume (uL)':'10'})],
    'ai5': [Mock(id='bo1', container=NamedMock(real_name='OutputName1'), location=('ContainerVariable1', 'E:1'), udf={'CFP_DNA_Volume (uL)':'50', 'CFP_RSB_Volume (uL)':'10'})],
    'ai6': [Mock(id='bo1', container=NamedMock(real_name='OutputName1'), location=('ContainerVariable1', 'F:1'), udf={'CFP_DNA_Volume (uL)':'50', 'CFP_RSB_Volume (uL)':'10'})],
    'ai7': [Mock(id='bo1', container=NamedMock(real_name='OutputName1'), location=('ContainerVariable1', 'G:1'), udf={'CFP_DNA_Volume (uL)':'50', 'CFP_RSB_Volume (uL)':'10'})],
    'ai8': [Mock(id='bo1', container=NamedMock(real_name='OutputName1'), location=('ContainerVariable1', 'H:1'), udf={'CFP_DNA_Volume (uL)':'50', 'CFP_RSB_Volume (uL)':'10'})],
    'ai9': [Mock(id='bo1', container=NamedMock(real_name='OutputName1'), location=('ContainerVariable1', 'A:2'), udf={'CFP_DNA_Volume (uL)':'50', 'CFP_RSB_Volume (uL)':'10'})],
    'ai10': [Mock(id='bo1', container=NamedMock(real_name='OutputName1'), location=('ContainerVariable1', 'A:2'), udf={'CFP_DNA_Volume (uL)':'50', 'CFP_RSB_Volume (uL)':'10'})]
}
