...
class TestGenerateHamiltonInputQPCR(TestEPP):
    ...
    def test_happy_input(self):  # test that file is written under happy path conditions i.e. 1 input plate, 1 output
        ...
        expected_lines = [
            ...
            'input_art_A:1,input_uri_container_1,A1,output_uri_container_8,A1,B1,C1,LP9999999-DIL1,LP9999999-DIL2,LP9999999-QSTD,LP9999999-QMX',
            'input_art_B:1,input_uri_container_1,B1,output_uri_container_8,D1,E1,F1,LP9999999-DIL1,LP9999999-DIL2,LP9999999-QSTD,LP9999999-QMX',
            'QSTD A1,input_uri_container_2,11,output_uri_container_8,A2,G1,H1,LP9999999-DIL1,LP9999999-DIL2,LP9999999-QSTD,LP9999999-QMX',
            'QSTD B1,input_uri_container_3,11,output_uri_container_8,B2,C2,D2,LP9999999-DIL1,LP9999999-DIL2,LP9999999-QSTD,LP9999999-QMX',
            'QSTD C1,input_uri_container_4,11,output_uri_container_8,E2,F2,G2,LP9999999-DIL1,LP9999999-DIL2,LP9999999-QSTD,LP9999999-QMX',
            'QSTD D1,input_uri_container_5,11,output_uri_container_8,A3,B3,H2,LP9999999-DIL1,LP9999999-DIL2,LP9999999-QSTD,LP9999999-QMX',
            'QSTD E1,input_uri_container_6,11,output_uri_container_8,C3,D3,E3,LP9999999-DIL1,LP9999999-DIL2,LP9999999-QSTD,LP9999999-QMX',
            'QSTD F1,input_uri_container_7,11,output_uri_container_8,F3,G3,H3,LP9999999-DIL1,LP9999999-DIL2,LP9999999-QSTD,LP9999999-QMX',
            ''
        ]
        assert self.file_content('a_file_location-hamilton_input.csv') == expected_lines
        assert self.stripped_md5('a_file_location-hamilton_input.csv') == 'c91b771c5ba048be05e3e02c1d8ca380'
        assert self.stripped_md5(self.epp.shared_drive_file_path) == 'c91b771c5ba048be05e3e02c1d8ca380'
