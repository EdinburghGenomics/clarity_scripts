...
def fake_all_inputs1(unique=False, resolve=False):
    """Return a list of 2 mocked artifacts which has the container name and the location defined as a tuple. The first
     mock artifact is assigned a name as this is used in one of the error messages during testing"""
    return (
...
def fake_all_inputs2(unique=False, resolve=False):
    """Return a list of 10 mocked artifacts which has the container name and the location defined as a tuple."""
    return (
...
def fake_outputs_per_input1(inputid, Analyte=False):
    ...
    outputs = {
        ...
        'ai3': [
            Mock(id='bo1', container=(NamedMock(real_name='OutputName1')), location=('ContainerVariable1', 'C:1'))],
        'ai4': [
            Mock(id='bo1', container=(NamedMock(real_name='OutputName1')), location=('ContainerVariable1', 'D:1'))],
        'ai5': [
            Mock(id='bo1', container=(NamedMock(real_name='OutputName1')), location=('ContainerVariable1', 'E:1'))],
        'ai6': [
            Mock(id='bo1', container=(NamedMock(real_name='OutputName1')), location=('ContainerVariable1', 'F:1'))],
        'ai7': [
            Mock(id='bo1', container=(NamedMock(real_name='OutputName1')), location=('ContainerVariable1', 'G:1'))],
        'ai8': [
            Mock(id='bo1', container=(NamedMock(real_name='OutputName1')), location=('ContainerVariable1', 'H:1'))],
        'ai9': [
            Mock(id='bo1', container=(NamedMock(real_name='OutputName1')), location=('ContainerVariable1', 'A:2'))],
        'ai10': [
            Mock(id='bo1', container=(NamedMock(real_name='OutputName1')), location=('ContainerVariable1', 'A:2'))]
    }
    return (
