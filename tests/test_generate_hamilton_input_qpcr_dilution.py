...
class TestGenerateHamiltonInputQPCRDilution(TestEPP):
    ...
    def test_generate_hamilton_input_qpcr_dilution(self):
        ...
        expected_file_contents = [
            ...
            'input_uri_container_1,A1,input_uri_container_1,A1,15,LP9999999-RSB,10',
            'input_uri_container_1,B1,input_uri_container_1,B1,15,LP9999999-RSB,9',
            'input_uri_container_1,C1,input_uri_container_1,C1,15,LP9999999-RSB,8']
        expected_file_md5sums = '84015fcae511c2a70585f787333568c0'
