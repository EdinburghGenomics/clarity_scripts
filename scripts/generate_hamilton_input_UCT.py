...
class GenerateHamiltonInputUPL(StepEPP):
    """"Generate a CSV containing the necessary information to transfer sample from an IMP plate into the UCT plate
    for KAPA library prep"""
    ...
    def _run(self):
        ...
        csv_column_headers = ['Input Plate', 'Input Well', 'Output Plate', 'Output Well']
