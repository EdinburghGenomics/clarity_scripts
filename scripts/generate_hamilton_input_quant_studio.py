...
class GenerateHamiltonInputQuantStudio(StepEPP):
    ...
    def __init__(self, argv=None):
        ...
        self.hamilton_input_2 = self.cmd_args.hamilton_input_2
        self.hamilton_input_3 = self.cmd_args.hamilton_input_3
    ...
    def add_args(argparser):
        ...
        argparser.add_argument(
            '-j', '--hamilton_input_2', type=str, required=True, help='Hamilton input file generated by the LIMS'
        )

        argparser.add_argument(
            '-k', '--hamilton_input_3', type=str, required=True, help='Hamilton input file generated by the LIMS'
        )
    ...
    def _run(self):
        ...
        self.write_csv(self.hamilton_input + '-hamilton_input_1.csv', csv_array[0][0])

        if csv_array[1] > 0:
            self.write_csv(self.hamilton_input_2 + '-hamilton_input_2.csv', csv_array[0][1])

        if csv_array[1] > 1:
            self.write_csv(self.hamilton_input_3 + '-hamilton_input_3.csv', csv_array[0][2])
